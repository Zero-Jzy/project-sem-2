                                        ...
                                        <div class="product_item">
                                            <div class="product_img">
                                                <img width="260" height="204"
                                                     src="https://cdn.tgdd.vn/Files/2017/04/22/974967/nhung-luu-y-ban-can-nho-khi-che-bien-cac-mon-an-tu-rau-xanh-2_760x506.jpg"
                                            ...
                                            <div class="product_hover">
                                                <div class="product_hover_cont"><h3 class="woocommerce-loop-product__title"
                                                                                    style="">
                                                        Garlic Sauteed Vegetables</h3>
                                                    <p><strong>Ingredient</strong></p>
                                                    <p>Vegetables , Garlic</p>
                                                 </div>
                                            </div>
