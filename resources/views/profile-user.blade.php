            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="menu-left col-md-3 container mt-3">
                        <div class="profiles">
                            <p class="image">
                                <img src="https://salt.tikicdn.com/desktop/img/avatar.png?v=3" height="45" width="45" alt="">
                            </p>
...
{{--                            </button>--}}
                            <ul class="nav nav-tabs" style="width: 100%;">
                                <li style="padding-top: 30px" class="">
                                    <a class="nav-link active" data-toggle="tab" href="#content" style="display: flex;align-items: center;"><i class="fas fa-user" style="flex: 0 0 20%;text-align: center;padding-right: 26px;"></i>Thông tin tài khoản</a>
                                </li>
                                <li style="padding-top: 30px" class="">
                                    <a class="nav-link" data-toggle="tab" href="#content1" style="display: flex;align-items: center;"><i class="fas fa-map-marker-alt" style="flex: 0 0 20%;text-align: center;padding-right: 26px;"></i>Sổ địa chỉ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div id="content" class="content-right container tab-pane active">
                            ...
                            <form>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" readonly class="form-control" id="staticEmail" value="Hoài Anh">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Điện thoại</label>
                                    <div class="col-sm-10">
                                        <input type="number"  readonly class="form-control" id="inputPassword" value="0869699109">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="text" readonly class="form-control" id="staticEmail" value="vuhonghoaianh1609@gmail.com">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Tuổi</label>
                                    <div class="col-sm-10">
                                        <input type="number" readonly class="form-control" id="inputPassword" value="19">
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-warning mb-2" style="margin-left: 165px">Cập nhật</button>
                            </form>
                        </div>
...
{{--                                    <label for="sel1">Thành phố:</label>--}}
                                ...
                                <div class="form-group row  has-feedback">
                                    <label for="street" class="col-lg-2 col-md-2 control-label visible-md-block visible-lg-block">Địa chỉ:</label>
                                    <div class="col-lg-10 col-md-10">
                                        <textarea class="form-control" id="street" name="street" cols="30" rows="10" placeholder="Nhập địa chỉ" data-bv-field="street"></textarea><i class="form-control-feedback" data-bv-icon-for="street" style="display: none;"></i>
